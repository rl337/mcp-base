...
class TestMetricsCollector(MetricsCollector):
    ...
    def track_tool_execution(self, tool_name: str) -> Any:
        ...
        execution = ToolExecution(tool_name=tool_name, start_time=datetime.now())
    ...
    def get_tool_execution_count(self, tool_name: str | None = None) -> int:
    ...
    def get_success_count(self, tool_name: str | None = None) -> int:
    ...
    def get_error_count(self, tool_name: str | None = None) -> int:
    ...
    def get_average_duration(self, tool_name: str | None = None) -> float | None:
...
class TestTracingCollector(TracingCollector):
    ...
    def trace_span(
        ...
        span = TraceSpan(name=name, attributes=attributes or {}, kind=kind)
    ...
    def add_span_event(self, name: str, attributes: dict[str, Any] | None = None) -> None:
        ...
        if self._active_spans:
            self._active_spans[-1].events.append({"name": name, "attributes": attributes or {}})
    ...
    def get_span_count(self, name: str | None = None) -> int:
        """Get count of spans.
